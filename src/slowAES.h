...
private:
	...
	void invRound(uint8_t *, uint8_t *);
	void mixColumns(uint8_t *, bool);
	void mixColumn(uint8_t *, bool);
	uint8_t galois_multiplication(uint16_t, uint16_t);
	void subBytes(uint8_t *, bool);
	void shiftRows(uint8_t *, bool);
	void shiftRow(uint8_t *, uint8_t, uint8_t, bool);
	void createRoundKey(uint8_t *, uint8_t, uint8_t *);
	void addRoundKey(uint8_t *, uint8_t *);
	uint8_t numberOfRounds(uint8_t size);
	void expandKey(uint8_t *, uint8_t, uint8_t *);
	void rotate(uint8_t *);
	void core(uint8_t *, uint16_t);
...
void toNumbers(const char *, uint8_t *);
